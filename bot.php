      ...
      if ( !(($value >= 0) and ($value <= 999999) and $len == 6)){
		...
		if(strstr($text,"ถูกหวย")){
			...
			$wword = array(
				...
				"เดือนนี้ก็ไม่ต้องกินมาม่าแล้วสิ",
				"รวยยยยยย กินไรดี เลี้ยงผมด้วยนะ",
				"ใครถูกๆ ซื้อหวยตามผม ไม่ผิดหวัง",
				"เฮ้ยถูกหวยเหรอ เฮงๆ รวยๆ ปังๆ",
				"สุดยอดดดดด ถูกรางวัลที่ 1 เลยใช่มะ รวยยยยย",
		...
		if(strstr($text,"บอทกาก")) {
			...
			$replyMsg =	'วิธีตรวจหวยงวดล่าสุด'.chr(10).'ให้พิมพ์คำว่า ตรวจหวย เว้นวรรค ตามด้วยตัวเลข 6 หลัก เช่น'.chr(10).'"ตรวจหวย 123456"'.chr(10).chr(10).'พิมพ์ "เรียงเบอร์" เพื่อดูผล งวดล่าสุด';
